  ...
  for(var linea of lineas) {
      ...
      if(split[0]!=espacio && linea.includes("#")==false && k2>7){
        ...
        if(seccion == 0){
          ...
          if(split[3] == '0'){
            $("#mytable tbody").append('<td><label><input type="checkbox" value="0" name="lunes[]"/><span class="label-text"></span></label></td>');
          }else{
            $("#mytable tbody").append('<td><label><input type="checkbox" value="1" name="lunes[]" checked/><span class="label-text"></span></label></td>');
          }
          

          if(split[4] == '0'){
            $("#mytable tbody").append('<td><label><input type="checkbox" value="0" name="martes[]"/><span class="label-text"></span></label></td>');
          }else{
            $("#mytable tbody").append('<td><label><input type="checkbox" value="1" name="martes[]" checked/><span class="label-text"></span></label></td>');
          }
          

          if(split[5] == '0'){
            $("#mytable tbody").append('<td><label><input type="checkbox" value="0" name="miercoles[]"/><span class="label-text"></span></label></td>>');
          }else{
            $("#mytable tbody").append('<td><label><input type="checkbox" value="1" name="miercoles[]" checked/><span class="label-text"></span></label></td>');
          }
          
          if(split[6] == '0'){
            $("#mytable tbody").append('<td><label><input type="checkbox" value="0" name="jueves[]"/><span class="label-text"></span></label></td>>');
          }else{
            $("#mytable tbody").append('<td><label><input type="checkbox" value="1" name="jueves[]" checked/><span class="label-text"></span></label></td>');
          }

          if(split[7] == '0'){
            $("#mytable tbody").append('<td><label><input type="checkbox" value="0" name="viernes[]"/><span class="label-text"></span></label></td>>');
          }else{
            $("#mytable tbody").append('<td><label><input type="checkbox" value="1" name="viernes[]" checked/><span class="label-text"></span></label></td>');
          }

          if(split[8] == '0'){
            $("#mytable tbody").append('<td><label><input type="checkbox" value="0" name="sabado[]" /><span class="label-text"></span></label></td>');
          }else{
            $("#mytable tbody").append('<td><label><input type="checkbox" value="1" name="sabado[]" checked/><span class="label-text"></span></label></td>');
          }

          if(split[9] == '0'){
            $("#mytable tbody").append('<td><label><input type="checkbox" value="0" name="domingo[]" /><span class="label-text"></span></label></td>');
          }else{
            $("#mytable tbody").append('<td><label><input type="checkbox" value="1" name="domingo[]" checked/><span class="label-text"></span></label></td>');
          }
